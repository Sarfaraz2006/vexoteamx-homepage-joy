...
import { Facebook, Twitter, Instagram, Linkedin, Download, Moon } from "lucide-react";
  ...
  return (
    <main className="hero-surface min-h-screen w-full px-4 py-6 sm:px-8 sm:py-10">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-card/85 shadow-[var(--shadow-panel)] ring-1 ring-border backdrop-blur">
        ...
        <section className="grid items-center gap-10 px-6 pb-14 pt-8 sm:px-10 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-5 flex gap-4 text-neon">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a key={i} href="#" aria-label="Social link" className="transition-opacity hover:opacity-70">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#" className="btn-neon rounded-md px-6 py-2 text-sm font-medium">
                Hire Us
              </a>
              <a href="#" className="btn-neon rounded-md px-6 py-2 text-sm font-medium">
                Contact Us
